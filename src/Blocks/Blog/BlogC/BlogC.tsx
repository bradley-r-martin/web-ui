...
import { BlogCProps } from './BlogC.Definition'

const BlogC: FunctionComponent<BlogCProps> = (props) => {
  return (
    <section className='text-gray-600 body-font overflow-hidden'>
      <div className='container px-5 py-24 mx-auto'>
        <div className='flex flex-wrap -m-12'>
          <div className='p-12 md:w-1/2 flex flex-col items-start'>
            <span className='inline-block py-1 px-2 rounded bg-indigo-50 text-sky-500 text-xs font-medium tracking-widest'>
              CATEGORY
            </span>
