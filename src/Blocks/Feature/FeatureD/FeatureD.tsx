...
import { FeatureDProps } from './FeatureD.Definition'

const FeatureD: FunctionComponent<FeatureDProps> = (props) => {
  return (
        ...
        <div className='flex flex-wrap -m-4'>
          <div className='p-4 lg:w-1/2 md:w-full'>
            <div className='flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col'>
              <div className='w-16 h-16 sm:mr-8 sm:mb-0 mb-4 inline-flex items-center justify-center rounded-full bg-indigo-100 text-blue-500 flex-shrink-0'>
                <svg
                  fill='none'
                  stroke='currentColor'
                  strokeLinecap='round'
