...
import { StatisticBProps } from './StatisticB.Definition'

const StatisticB: FunctionComponent<StatisticBProps> = (props) => {
  return (
          ...
          <div className='p-4 md:w-1/4 sm:w-1/2 w-full'>
            <div className='border-2 border-gray-200 px-4 py-6 rounded-lg'>
              <svg
                ...
                strokeWidth='2'
                className='text-sky-500 w-12 h-12 mb-3 inline-block'
                viewBox='0 0 24 24'
              >
