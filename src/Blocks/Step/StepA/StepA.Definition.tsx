  ...
  return {
    ...
    icon: (
      <svg className="w-full" viewBox="0 0 266 150" fill="none">
        ...
        <path d="M24 28.5a.5.5 0 011 0v94a.5.5 0 01-1 0v-94z"
          // fill="var(--base-400)"
          fill="currentColor"
          className="text-slate-400"
        ></path>
        <path d="M29 30.5a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z"
          // fill="var(--main-500)"
          fill="currentColor"
          className="text-sky-500"
        ></path>
        <path d="M34 35a1 1 0 011-1h54a1 1 0 110 2H35a1 1 0 01-1-1z"
          // fill="var(--base-500)"
          fill="currentColor"
          className="text-slate-500"
        ></path>
        <rect x="34" y="28" width="35" height="3" rx="1.5"
          // fill="var(--solid-900)"
          fill="currentColor"
          className="text-slate-900"
        ></rect>
        <path d="M29 52.5a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z"
          // fill="var(--main-500)"
          fill="currentColor"
          className="text-sky-400"
        ></path>
        <path d="M34 57a1 1 0 011-1h54a1 1 0 110 2H35a1 1 0 01-1-1z"
          // fill="var(--base-500)"
          fill="currentColor"
          className="text-slate-500"
        ></path>
        <rect x="34" y="50" width="35" height="3" rx="1.5"
          // fill="var(--solid-900)"
          fill="currentColor"
          className="text-slate-900"
        ></rect>
        <path d="M29 74.5a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z"
          // fill="var(--main-500)"
          fill="currentColor"
          className="text-sky-500"
        ></path>
        <path d="M34 79a1 1 0 011-1h54a1 1 0 110 2H35a1 1 0 01-1-1z"
          // fill="var(--base-500)"
          fill="currentColor"
          className="text-slate-500"
        ></path>
        <rect x="34" y="72" width="35" height="3" rx="1.5"
          // fill="var(--solid-900)"
          fill="currentColor"
          className="text-slate-900"
        ></rect>
        <path d="M29 96.5a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z"
          // fill="var(--main-500)"
          fill="currentColor"
          className="text-sky-500"
        ></path>
        <path d="M34 101a1 1 0 011-1h54a1 1 0 010 2H35a1 1 0 01-1-1z"
          // fill="var(--base-500)"
          fill="currentColor"
          className="text-slate-500"
        ></path>
        <rect x="34" y="94" width="35" height="3" rx="1.5"
          // fill="var(--solid-900)"
          fill="currentColor"
          className="text-slate-900"
        ></rect>
        <path d="M29 118.5a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z"
          // fill="var(--main-500)"
          fill="currentColor"
          className="text-sky-500"
        ></path>
        <path d="M34 123a1 1 0 011-1h54a1 1 0 010 2H35a1 1 0 01-1-1z"
          // fill="var(--base-500)"
          fill="currentColor"
          className="text-slate-500"
        ></path>
        <rect x="34" y="116" width="35" height="3" rx="1.5"
          // fill="var(--solid-900)"
          fill="currentColor"
          className="text-slate-900"
        ></rect>
